...
export const startSession = async (config, args, cols = 80, rows = 30) => {
...
export const startShell = async (shell) => createTerminal({ shell, env: baseEnv, timeouts, retries: 2 });
